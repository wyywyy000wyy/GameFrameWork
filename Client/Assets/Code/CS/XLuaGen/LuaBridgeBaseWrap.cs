    ...
    public class LuaBridgeBaseWrap 
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					LuaBridgeBase gen_ret = new LuaBridgeBase();
        ...
        static int _m_Bind_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    LuaBridgeType _bridgeType;translator.Get(L, 1, out _bridgeType);
                    ...
                    XLua.LuaTable _LuaDLL = (XLua.LuaTable)translator.GetObject(L, 4, typeof(XLua.LuaTable));
                        ...
                        UnityEngine.Component gen_ret = LuaBridgeBase.Bind( _bridgeType, _go, _luaTbl, _LuaDLL );
                        translator.Push(L, gen_ret);
