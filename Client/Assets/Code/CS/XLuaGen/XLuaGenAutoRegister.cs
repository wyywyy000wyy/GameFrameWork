...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit0(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(Packet), PacketWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(WarNet), WarNetWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(NetEventType), NetEventTypeWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(LuaFilePicker), LuaFilePickerWrap.__Register);
            ...
            translator.DelayWrapLoader(typeof(YSLoader), YSLoaderWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Map), MapWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(MapResourceCenter), MapResourceCenterWrap.__Register);
        ...
        static void wrapInit1(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(System.Collections.Generic.List<byte>), SystemCollectionsGenericList_1_SystemByte_Wrap.__Register);
        ...
        static void wrapInit2(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(UIContainer), UIContainerWrap.__Register);
