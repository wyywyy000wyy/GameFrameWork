...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp7(NetEventType p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
                ...
                int errFunc = LuaAPI.pcall_prepare(L, errorFuncRef, luaReference);
                ObjectTranslator translator = luaEnv.translator;
                translator.PushNetEventType(L, p0);
		...
		public void __Gen_Delegate_Imp8(Packet p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp9(bool p0, UnityEngine.Texture2D p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp10(int p0, UnityEngine.Transform p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp11(int p0, int p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(System.Action<NetEventType>))
			{
			    return new System.Action<NetEventType>(__Gen_Delegate_Imp7);
			}
		
		    if (type == typeof(System.Action<Packet>))
			{
			    return new System.Action<Packet>(__Gen_Delegate_Imp8);
			}
		
		    if (type == typeof(System.Action<bool, UnityEngine.Texture2D>))
			{
			    return new System.Action<bool, UnityEngine.Texture2D>(__Gen_Delegate_Imp9);
			}
		
		    if (type == typeof(System.Action<int, UnityEngine.Transform>))
			{
			    return new System.Action<int, UnityEngine.Transform>(__Gen_Delegate_Imp10);
			}
		
		    if (type == typeof(System.Action<int, int>))
			{
			    return new System.Action<int, int>(__Gen_Delegate_Imp11);
			}
