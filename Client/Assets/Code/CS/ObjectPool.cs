...
namespace Hugula.Utils
{
    ...
    public class ObjectPool<T> where T : new()
    {
        ...
        public void Release(T element)
        {
            ...
            {
                Debug.LogError($"Internal error. Trying to destroy object {element} that is already released to pool.");
                return;
            }
    ...
    public class GameObjectPool<T> where T : Component
    {
        ...
        private Dictionary<int, Stack<T>> m_StackDic = new Dictionary<int, Stack<T>>(32);
