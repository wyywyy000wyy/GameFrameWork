...
prop_rpg_battle_group = {
	...
	[RPG_BATTLE_GROUP_134] = { ID = RPG_BATTLE_GROUP_134, Type = 1, Stack = 1, MaxLevel = 10, Limit = nil, Immune = nil, VFXGroup = "ef_buff_rpg_suduup", Text = LG_SKILL_ATTR_NAME_102900135,},
