...
namespace NFMsg {
  ...
  #endif
  {
    ...
    private global::NFMsg.EServerState serverState_ = global::NFMsg.EServerState.EST_CRASH;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    ...
    public override int GetHashCode() {
      ...
      if (ServerState != global::NFMsg.EServerState.EST_CRASH) hash ^= ServerState.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (ServerState != global::NFMsg.EServerState.EST_CRASH) {
    ...
    public void MergeFrom(ServerInfoReport other) {
      ...
      if (other.ServerState != global::NFMsg.EServerState.EST_CRASH) {
  ...
  #endif
  {
    ...
    private global::NFMsg.ELoginMode loginMode_ = global::NFMsg.ELoginMode.ELM_LOGIN;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    ...
    public override int GetHashCode() {
      ...
      if (LoginMode != global::NFMsg.ELoginMode.ELM_LOGIN) hash ^= LoginMode.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (LoginMode != global::NFMsg.ELoginMode.ELM_LOGIN) {
        output.WriteRawTag(56);
    ...
    public void MergeFrom(ReqAccountLogin other) {
      ...
      if (other.LoginMode != global::NFMsg.ELoginMode.ELM_LOGIN) {
  ...
  #endif
  {
    ...
    private global::NFMsg.EServerState status_ = global::NFMsg.EServerState.EST_CRASH;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    ...
    public override int GetHashCode() {
      ...
      if (Status != global::NFMsg.EServerState.EST_CRASH) hash ^= Status.GetHashCode();
      if (_unknownFields != null) {
        hash ^= _unknownFields.GetHashCode();
      }
      return hash;
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (Status != global::NFMsg.EServerState.EST_CRASH) {
        output.WriteRawTag(32);
    ...
    public void MergeFrom(ServerInfo other) {
      ...
      if (other.Status != global::NFMsg.EServerState.EST_CRASH) {
        Status = other.Status;
      }
      _unknownFields = pb::UnknownFieldSet.MergeFrom(_unknownFields, other._unknownFields);
    }
  ...
  #endif
  {
    ...
    private global::NFMsg.ReqServerListType type_ = global::NFMsg.ReqServerListType.RSLT_WORLD_SERVER;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (Type != global::NFMsg.ReqServerListType.RSLT_WORLD_SERVER) hash ^= Type.GetHashCode();
      if (_unknownFields != null) {
        hash ^= _unknownFields.GetHashCode();
      }
      return hash;
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      output.WriteRawMessage(this);
    #else
      if (Type != global::NFMsg.ReqServerListType.RSLT_WORLD_SERVER) {
        output.WriteRawTag(8);
    ...
    public void MergeFrom(ReqServerList other) {
      ...
      if (other.Type != global::NFMsg.ReqServerListType.RSLT_WORLD_SERVER) {
        Type = other.Type;
      }
      _unknownFields = pb::UnknownFieldSet.MergeFrom(_unknownFields, other._unknownFields);
    }
