...
class MsgBaseI final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR MsgBaseI(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  MsgBaseI* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
