...
class ReqEnterGameServer final :
 ...
 public:
  ...
  explicit constexpr ReqEnterGameServer(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class ReqAckEnterGameSuccess final :
 ...
 public:
  ...
  explicit constexpr ReqAckEnterGameSuccess(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class ReqHeartBeat final :
 ...
 public:
  ...
  explicit constexpr ReqHeartBeat(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class PlayerEntryInfo final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_class_id();
  ...
  PROTOBUF_MUST_USE_RESULT ::NFMsg::Ident* release_object_guid();
...
class PosSyncUnit final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::NFMsg::Ident* release_mover();
  ...
  PROTOBUF_MUST_USE_RESULT ::NFMsg::Vector3* release_pos();
  ...
  PROTOBUF_MUST_USE_RESULT ::NFMsg::Vector3* release_orientation();
...
class EffectData final :
 ...
 public:
  ...
  ~EffectData() override;
  explicit constexpr EffectData(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT ::NFMsg::Ident* release_effect_ident();
...
class ReqAckUseSkill final :
 ...
 public:
  ...
  explicit constexpr ReqAckUseSkill(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_skill_id();
  ...
  PROTOBUF_MUST_USE_RESULT ::NFMsg::Ident* release_user();
...
class ReqAckSwapScene final :
 ...
 public:
  ...
  explicit constexpr ReqAckSwapScene(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class ReqAckPlayerChat final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_chat_info();
...
void ReqAckUseSkill::set_skill_id(ArgT0&& arg0, ArgT... args) {
 ...
 skill_id_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void ReqAckUseSkill::_internal_set_skill_id(const std::string& value) {
  ...
  skill_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* ReqAckUseSkill::_internal_mutable_skill_id() {
  
  return skill_id_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* ReqAckUseSkill::release_skill_id() {
  // @@protoc_insertion_point(field_release:NFMsg.ReqAckUseSkill.skill_id)
  return skill_id_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
...
void ReqAckPlayerChat::set_player_name(ArgT0&& arg0, ArgT... args) {
 ...
 player_name_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
