local rpg_bullet = class2("rpg_bullet", T.rpg_effect_actor, function(self, eff_env, target_orient, param)
    ...
    local bullet_type = param[1] == RPG_BULLET_TYPE.MULTI_LINE and RPG_BULLET_TYPE.LINE or param[1]
...
function rpg_bullet:destroy()
    ...
    if self._is_anger then
        self._ins._battle_mod:remove_rupdate(self)
    else
        self._ins._battle_mod:remove_bupdate(self)
    end
end
